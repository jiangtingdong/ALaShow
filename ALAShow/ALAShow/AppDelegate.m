...
#import "ALAMainTabBarController.h"
...
- (void)initWithApp
{
    ...
    ALAMainTabBarController *mainTabBar = [[ALAMainTabBarController alloc] init];
    ...
    mainTabBar.viewControllers = @[[hotTopSB instantiateInitialViewController],[sendGoodsSB instantiateInitialViewController],[myCenterSB instantiateInitialViewController]];
